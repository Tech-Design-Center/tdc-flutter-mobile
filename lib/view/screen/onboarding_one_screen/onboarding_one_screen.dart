        ...
        builder: (BuildContext context, Widget? child) {
          return Scaffold(
            body: SafeArea(
                                ...
                                child: Container(
                                  ...
                                  child: Text(
                                    ...
                                    style: TextStyle(
                                      ...
                                      fontSize: ScreenUtil().setSp(120),                            fontFamily: 'Poppins',
              ...
              margin: EdgeInsets.only(left: 19, top: 12, right: 19,).r,
              alignment: Alignment.center,
              child: Text('Continue',style: TextStyle(fontSize: 65.sp),),),
                      ),
                    ...
                    Align(
                      ...
                      Navigator.of(context).pushAndRemoveUntil(
                          ...
                          child: Container(
                            padding: EdgeInsets.only(bottom:80,top:50,left: 100,right: 100).r ,
                            alignment: Alignment.center,
                            width: 5.sw,
                            child: Text(
                              "Skip",
